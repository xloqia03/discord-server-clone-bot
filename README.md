...
You can add **Habab Clone Bot** directly to your Discord server using the official authorization link:

👉 **[Add Habab Clone Bot to Discord](https://discord.com/oauth2/authorize?client_id=1543645199912280084)**

### 🔄 Clone Server Command

Once the bot is added to your server with the required permissions, use the slash command:
